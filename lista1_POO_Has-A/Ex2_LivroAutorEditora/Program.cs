...
namespace Ex2_LivroAutorEditora
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Editora editora = new Editora("senas", 83777963000123);
            Autor autor = new Autor("681.065.123-39", "Thamirys Vilar Donato", data);
            Livro livro = new Livro("The Killer", data2, "978-857-334-0400-5", 5, autor, editora);
            ...
            Console.WriteLine("Nome da Editora: " + livro.Editora.Nome.ToString());
            ...
            Console.WriteLine("Nome: " + editora.Nome.ToString());
            Console.WriteLine("CPF: " + editora.CNPJ.ToString());
